...
class Entrypage:
    def __init__(self,uname,utype):
        ...
        # Accelerator command for manage user
        ...
        self.menu4.add_command(label="Manage User", command=lambda: UserClass(self.window), image=self.d1
                               , compound=LEFT, accelerator="Ctrl+c")
        self.window.bind("<Control-c>", lambda e: UserClass(self.window))

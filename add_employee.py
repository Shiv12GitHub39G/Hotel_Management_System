...
class add_employee:
    ...
    def __init__(self,hwindow,col=None):
        ...
        self.v2=StringVar()
        self.c1=Combobox(self.window,values=["Clerks","Housekeeping","Kitchen Staff",
...
#   STEP 1: MAKE DATABASE CONNECTION
    ...
    def validate_check(self):
        ...
        if not(self.t1.get().isalpha())   or  len(self.t1.get())<2:
            ...
            messagebox.showwarning("Validation Check", "Enter valid phone no.10 digits only", parent=self.window)
            return False

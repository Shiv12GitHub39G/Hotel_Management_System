...
#         ----------Printout---------
    ...
    def getPrintout(self):
        ...
        # pdf.print_chapter(self.mypdata,headings,8)

        headings = ['Name','DOB','Gender','Job','Salary','Phone','Aadhar']
        pdf.print_chapter(self.mypdata,headings,7)

...
class manager_info:
    def __init__(self,hwindow):
        ...
        self.window.title("Manager Details")
        # --------Window settings-----
        ...
        bg="#c28cf5"
        fg="white"
        self.hd=Label(self.window,text="Manager Details",font=font1,
...
#         ------fetching data and making connection with the database----
    ...
    def fetchAllData(self):
        ...
        # Name DOB Gender Job Salary Phone Aadhar Email
        try:
            myqry="select * from employee where Job like %s"
            rowcount=self.curr.execute(myqry,("manager"+"%"))

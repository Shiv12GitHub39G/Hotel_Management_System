...
class LoginClass:
    def __init__(self):
        ...
        # code to use accelerator command for shortcut
        # self.icon_img1 = Image.open("C:\\Users\\Dell\\Pictures\\Screenshots\\d1.png")
        # self.icon_img1 = self.icon_img1.resize((20, 20))
        #
        # self.d1 = ImageTk.PhotoImage(self.icon_img1)
        #
        # self.menu1.add_command(label="Customer Details", command=lambda: CustomerClass(self.window), image=self.d1
        #                        , compound=LEFT, accelerator="Ctrl+c")
        # self.window.bind("<Control-c>", lambda e: CustomerClass(self.window))
